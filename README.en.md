...
| **[key-rotator](https://github.com/Niko-Vanetti/key-rotator)** | `TypeScript` | KeyRotator: VS Code extension to rotate AI provider API keys and run an agent (NVIDIA Build/OpenRouter) with tools, agency mode and viability analysis | public |
| **niko-ide-verilog** | `TypeScript` | Web Verilog IDE in Spanish: editor, simulation and RTL view in the browser. | private |
| **niko-skills-unlocked** | `-` | Backup privado y completo de todas mis skills de Claude Code (incluye las personales) | private |
| **[niko-skills](https://github.com/Niko-Vanetti/niko-skills)** | `-` | Colección de skills genéricas para Claude Code / agentes IA — dev, negocio, contenido | public |
...
_Last refreshed: 2026-08-26 02:12 UTC_
